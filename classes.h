...
//{
//public:
//	int64_t N00000062; //0x0000
//	int64_t N00000063; //0x0008
//	int32_t N00000064; //0x0010
//	int8_t N00000297; //0x0014
//	bool OnZoom; //0x0015
//	char pad_0016[2]; //0x0016
//	int64_t N00000280; //0x0018
//	int64_t N00000282; //0x0020
//	int64_t N00000285; //0x0028
//	int32_t N00000283; //0x0030
//	vec3_t vecorigin; //0x0034
//	int64_t N00000274; //0x0040
//	int64_t N00000275; //0x0048
//	int64_t N00000276; //0x0050
//	int64_t N00000065; //0x0058
//	int64_t N00000066; //0x0060
//	char pad_0068[376]; //0x0068
//	vec3_t viewangle; //0x01E0
//	char pad_01EC[120]; //0x01EC
//	int32_t Health; //0x0264
//	char pad_0268[164]; //0x0268
//	bool radarEnabled; //0x030C
//	bool radarBlocked; //0x030D
//	bool radarShowEnemyDirection; //0x030E
//	int8_t RadarMode; //0x030F
//	char pad_0310[1140]; //0x0310
//	int32_t N0000014A; //0x0784
//	int32_t crosshair; //0x0788
//	char pad_078C[2368]; //0x078C
//}; //Size: 0x10CC
//
...
enum XAnimParameterType : __int8
{
	INVALID = 0x0,
	BOOL_VALUE = 0x1,
	BYTE_VALUE = 0x2,
...
struct XAnimParameterValue
{
	XAnimParameterType type;
	unsigned __int8 gameStructTypeID;
...
struct  XAnimTree
{
	...
	bool clientNotifyEnabled;
	_BYTE owner[1];
	XAnimTreeLodState lodState;
	XAnimParameterValue* parameterValues;
};

struct  DObjModelBits 
{
};
...
struct XModelMaterialOverride;

struct __declspec(align(4)) DSkelPartBits
{
	DObjPartBits anim;
	DObjPartBits control;
	DObjPartBits worldCtrl;
	DObjPartBits skel;
	bool animCalculated;
	bool blendShapesCalculated;
};
struct  DObj
{
	XAnimTree* tree;
